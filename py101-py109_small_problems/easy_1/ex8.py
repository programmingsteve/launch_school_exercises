...
# Gregorian calendar:
#
# If the year is divisible by 400, it is a leap year. If the year is divisible
# by 100 but not by 400, it is not a leap year. If the year is divisible by 4
# but not by 100, it is a leap year. All other years are not leap years.
